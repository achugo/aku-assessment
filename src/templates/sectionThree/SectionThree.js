...
import profile_url from "../../assets/profile4.png";
        ...
        <FlextItem flex={1}>
          <BackgroundDescription bgImage={bg} bottom="-120px" right="-50px">
            <ProfileCard
              ...
              imgurl={profile_url}
              italicSize="16px"
              description="“Exhibit Systems is not a provider. They are not a supplier. They are a partner with expertise in making trade shows effective.”"
              name="Eunice Oliver"
              designation="Founder & CEO, Zeem"
            />
